...
where id_group in (Select Id_group from dbsdi.dbo.tib_group where project_name like '%PICCMEX01-Logix_Offer_Publisher%');

--Los siguientes scripts son para eliminar en los group's
delete from dbsdi.dbo.tib_group
where project_name like '%PICCMEX01-Logix_Offer_Publisher%';
