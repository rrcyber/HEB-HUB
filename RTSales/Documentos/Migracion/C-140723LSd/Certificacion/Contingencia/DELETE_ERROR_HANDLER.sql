...
where id_group in (Select Id_group from dbsdi.dbo.tib_group where project_name like '%SCI201097-Logix_Offer_Publisher%');
...
where project_name like '%SCI201097-Logix_Offer_Publisher%';
