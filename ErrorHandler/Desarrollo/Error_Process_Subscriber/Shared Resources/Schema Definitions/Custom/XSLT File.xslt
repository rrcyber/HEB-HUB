...
<xsl:template match="/">
  <html>
  <body>
 <h4>Errors/Warnings by project - <xsl:value-of select="ERROR_Container/Header/ProjectName"/> :</h4>
    <table border="0">
      <tr bgcolor="#D2D0D4">
...
<h4>Note: The error detail is recorded in the table TIB_LOG_ERROR</h4>
  </body>
  </html>
</xsl:template>
</xsl:stylesheet>
