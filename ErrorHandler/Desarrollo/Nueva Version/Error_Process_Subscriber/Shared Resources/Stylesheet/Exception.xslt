...
<xsl:template match="/">
  <html>
  <body>
 <h4>Exception by project - <xsl:value-of select="ERROR_Container/Header/ProjectName"/> :</h4>
    <table border="0">
      <tr bgcolor="#D2D0D4">
...
<h4>Note: The error detail is recorded in the table DBSDI..TIB_LOG_EXCEPTION en el Server SXD201080</h4>
