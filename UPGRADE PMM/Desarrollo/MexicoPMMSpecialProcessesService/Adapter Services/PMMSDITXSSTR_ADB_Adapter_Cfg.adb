...
<Repository:repository xmlns:Repository="http://www.tibco.com/xmlns/repo/types/2002" xmlns:AESDK="http://www.tibco.com/xmlns/aemeta/adapter/2002" xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <ADB:adapter xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" name="PMMSDITXSSTR_ADB_Adapter_Cfg">
        <AESDK:instanceId>PMMSDITXSSTR_ADB_Adapter_Cfg</AESDK:instanceId>
        <AESDK:startup>
            ...
            <AESDK:startComponent>
                <AESDK:name>PMMSDITXSSTR_Pub_Svc</AESDK:name>
                <AESDK:state>active</AESDK:state>
            </AESDK:startComponent>
        </AESDK:startup>
        <AESDK:deployment>
            ...
            <AESDK:producers>
                <AESDK:jmsPublisher isRef="true">#jmsProducer.PMMSDITXSSTR_Pub_Svc</AESDK:jmsPublisher>
            </AESDK:producers>
        ...
        <AESDK:metadata>
            ...
            <AESDK:loadUrl isRef="false">/AESchemas/ae/ADB/PMMSDITXSSTR_ADB_Adapter_Cfg.aeschema</AESDK:loadUrl>
        </AESDK:metadata>
        ...
        <AESDK:designer>
            ...
            <AESDK:lockedProperties>
                ...
                <AESDK:locked>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMSDITXSSTR_Pub_Svc</AESDK:resource>
            ...
            <AESDK:fixedChildren>
                ...
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue</AESDK:resource>
                    <AESDK:children>PMMSDITXSSTR_Pub_Svc</AESDK:children>
                </AESDK:fixed>
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMSDITXSSTR_Pub_Svc</AESDK:resource>
                    <AESDK:children>PMM.HEB_P_SDITXSSTR</AESDK:children>
                </AESDK:fixed>
            </AESDK:fixedChildren>
            <AESDK:resourceDescriptions>
                <AESDK:node>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMSDITXSSTR_Pub_Svc</AESDK:resource>
                    <AESDK:description>Created for service PMMSDITXSSTR_Pub_Svc.</AESDK:description>
                </AESDK:node>
            </AESDK:resourceDescriptions>
            <AESDK:adapterTester>
        ...
        <activedb xmlns="http://www.tibco.com/xmlns/adapter/ADB/2002">
            ...
            <agentOptions>
                ...
                <verbose>on</verbose>
                <useTraceFile/>
                <termSubject>%%Destinations/Topics/SDITXSSTR_TERMINATION_TOPIC%%</termSubject>
        ...
        <operations xmlns="http://www.tibco.com/xmlns/adapter/ADB/2002">
            <publisher>
                <name>PMMSDITXSSTR_Pub_Svc</name>
                <deployed>true</deployed>
                <isAdorapps>false</isAdorapps>
                <transportType>jms</transportType>
                <destination>%%Destinations/Queues/TAXESLOCATION_PUB_ADB_QUEUE%%</destination>
                <endpointReference isRef="true">#jmsProducer.PMMSDITXSSTR_Pub_Svc</endpointReference>
                <classReference isRef="true">/AESchemas/ae/ADB/PMMSDITXSSTR_ADB_Adapter_Cfg.aeschema#class.PMM.HEB_P_SDITXSSTR</classReference>
                <schemas>
                    <table>
                        <name>P_SDITXSSTR</name>
                        ...
                        <userKeys>ORG_LVL_CHILD_S</userKeys>
                        <userKeys>ISS_TECH_KEY</userKeys>
                        <userKeys>TRAN_TYPE</userKeys>
                        <userKeys>AUDIT_NUMBER</userKeys>
                        <userKeys>TXS_AREA_TECH_KEY</userKeys>
                        <userKeys>TXS_AUTH_TECH_KEY</userKeys>
                    </table>
                </schemas>
                ...
                <sourceTable>PMM.SDITXSSTR</sourceTable>
                <publishingTable>PMM.HEB_P_SDITXSSTR</publishingTable>
                <updateMode>UPSERT</updateMode>
                <storageMode>VALUE</storageMode>
                <loopDetection>true</loopDetection>
                <columnsToPublish>ORG_LVL_CHILD</columnsToPublish>
                <columnsToPublish>ORG_LVL_CHILD_S</columnsToPublish>
                ...
                <columnsToPublish>TXS_AREA_TECH_KEY</columnsToPublish>
                <columnsToPublish>TXS_AUTH_TECH_KEY</columnsToPublish>
                <columnsToPublish>ORG_LVL_NUMBER</columnsToPublish>
                <columnsToPublish>ORG_LVL_NUMBER_S</columnsToPublish>
                <columnsToPublish>TXS_AREA_CODE</columnsToPublish>
                <columnsToPublish>TXS_AREA_DESC</columnsToPublish>
                <columnsToPublish>TXS_AUTH_CODE</columnsToPublish>
                <columnsToPublish>TXS_AUTH_DESC</columnsToPublish>
                <columnsToPublish>DATE_CREATED</columnsToPublish>
                <userDefinedKey>ORG_LVL_CHILD</userDefinedKey>
                <userDefinedKey>ORG_LVL_CHILD_S</userDefinedKey>
                ...
                <userDefinedKey>TXS_AREA_TECH_KEY</userDefinedKey>
                <userDefinedKey>TXS_AUTH_TECH_KEY</userDefinedKey>
    ...
    <jmsProducer xmlns="http://www.tibco.com/xmlns/aemeta/services/2002" name="PMMSDITXSSTR_Pub_Svc" objectType="endpoint.JMSPublisher">
        ...
        <class isRef="true">/AESchemas/ae/ADB/PMMSDITXSSTR_ADB_Adapter_Cfg.aeschema#class.PMM.HEB_P_SDITXSSTR</class>
    </jmsProducer>
