...
<Repository:repository xmlns:Repository="http://www.tibco.com/xmlns/repo/types/2002" xmlns:AESDK="http://www.tibco.com/xmlns/aemeta/adapter/2002" xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <ADB:adapter xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" name="PMMHEB_SDIAPHEE_ADB_Adapter_Cfg">
        <AESDK:instanceId>PMMHEB_SDIAPHEE_ADB_Adapter_Cfg</AESDK:instanceId>
        <AESDK:startup>
            ...
            <AESDK:startComponent>
                <AESDK:name>PMMHEB_SDIAPHEE_Pub_Svc</AESDK:name>
                <AESDK:state>active</AESDK:state>
            </AESDK:startComponent>
        </AESDK:startup>
        <AESDK:deployment>
            ...
            <AESDK:producers>
                <AESDK:jmsPublisher isRef="true">#jmsProducer.PMMHEB_SDIAPHEE_Pub_Svc</AESDK:jmsPublisher>
            </AESDK:producers>
        ...
        <AESDK:metadata>
            <AESDK:loadUrl isRef="false">/AESchemas/ae/ADB/PMMHEB_SDIAPHEE_ADB_Adapter_Cfg.aeschema</AESDK:loadUrl>
        ...
        <AESDK:designer>
            ...
            <AESDK:lockedProperties>
                ...
                <AESDK:locked>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMHEB_SDIAPHEE_Pub_Svc</AESDK:resource>
            ...
            <AESDK:fixedChildren>
                ...
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue</AESDK:resource>
                    <AESDK:children>PMMHEB_SDIAPHEE_Pub_Svc</AESDK:children>
                </AESDK:fixed>
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMHEB_SDIAPHEE_Pub_Svc</AESDK:resource>
                    <AESDK:children>PMM.HEB_P_HEB_SDIAPHEE</AESDK:children>
                </AESDK:fixed>
            </AESDK:fixedChildren>
            <AESDK:resourceDescriptions>
                <AESDK:node>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMHEB_SDIAPHEE_Pub_Svc</AESDK:resource>
                    <AESDK:description>Created for service PMMHEB_SDIAPHEE_Pub_Svc.</AESDK:description>
                </AESDK:node>
            </AESDK:resourceDescriptions>
            <AESDK:adapterTester>
        ...
        <activedb xmlns="http://www.tibco.com/xmlns/adapter/ADB/2002">
            ...
            <agentOptions>
                ...
                <verbose>on</verbose>
                <useTraceFile/>
                <termSubject>%%Destinations/Topics/HEB_SDIAPHEE_TERMINATION_TOPIC%%</termSubject>
        ...
        <operations xmlns="http://www.tibco.com/xmlns/adapter/ADB/2002">
            <publisher>
                <name>PMMHEB_SDIAPHEE_Pub_Svc</name>
                <deployed>true</deployed>
                <isAdorapps>false</isAdorapps>
                <transportType>jms</transportType>
                <destination>%%Destinations/Queues/ASSORTMENTPLANHEADER_PUB_ADB_QUEUE%%</destination>
                <endpointReference isRef="true">#jmsProducer.PMMHEB_SDIAPHEE_Pub_Svc</endpointReference>
                <classReference isRef="true">/AESchemas/ae/ADB/PMMHEB_SDIAPHEE_ADB_Adapter_Cfg.aeschema#class.PMM.HEB_P_HEB_SDIAPHEE</classReference>
                <schemas>
                    <table>
                        <name>P_HEB_SDIAPHEE</name>
                ...
                <sourceTable>PMM.HEB_SDIAPHEE</sourceTable>
                <publishingTable>PMM.HEB_P_HEB_SDIAPHEE</publishingTable>
    ...
    <jmsProducer xmlns="http://www.tibco.com/xmlns/aemeta/services/2002" name="PMMHEB_SDIAPHEE_Pub_Svc" objectType="endpoint.JMSPublisher">
        ...
        <class isRef="true">/AESchemas/ae/ADB/PMMHEB_SDIAPHEE_ADB_Adapter_Cfg.aeschema#class.PMM.HEB_P_HEB_SDIAPHEE</class>
    </jmsProducer>
