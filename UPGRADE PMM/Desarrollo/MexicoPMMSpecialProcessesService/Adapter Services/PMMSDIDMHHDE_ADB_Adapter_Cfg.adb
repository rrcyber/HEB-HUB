...
<Repository:repository xmlns:Repository="http://www.tibco.com/xmlns/repo/types/2002" xmlns:AESDK="http://www.tibco.com/xmlns/aemeta/adapter/2002" xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <ADB:adapter xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" name="PMMSDIDMHHDE_ADB_Adapter_Cfg">
        <AESDK:instanceId>PMMSDIDMHHDE_ADB_Adapter_Cfg</AESDK:instanceId>
        <AESDK:startup>
            ...
            <AESDK:startComponent>
                <AESDK:name>PMMSDIDMHHDE_Pub_Svc</AESDK:name>
                <AESDK:state>active</AESDK:state>
            </AESDK:startComponent>
        </AESDK:startup>
        <AESDK:deployment>
            ...
            <AESDK:producers>
                <AESDK:jmsPublisher isRef="true">#jmsProducer.PMMSDIDMHHDE_Pub_Svc</AESDK:jmsPublisher>
            </AESDK:producers>
        ...
        <AESDK:metadata>
            <AESDK:loadUrl isRef="false">/AESchemas/ae/ADB/PMMSDIDMHHDE_ADB_Adapter_Cfg.aeschema</AESDK:loadUrl>
        ...
        <AESDK:designer>
            ...
            <AESDK:lockedProperties>
                ...
                <AESDK:locked>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMSDIDMHHDE_Pub_Svc</AESDK:resource>
            ...
            <AESDK:fixedChildren>
                ...
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue</AESDK:resource>
                    <AESDK:children>PMMSDIDMHHDE_Pub_Svc</AESDK:children>
                </AESDK:fixed>
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMSDIDMHHDE_Pub_Svc</AESDK:resource>
                    <AESDK:children>PMM.HEB_P_SDIDMHHDE</AESDK:children>
                </AESDK:fixed>
            </AESDK:fixedChildren>
            <AESDK:resourceDescriptions>
                <AESDK:node>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMSDIDMHHDE_Pub_Svc</AESDK:resource>
                    <AESDK:description>Created for service PMMSDIDMHHDE_Pub_Svc.</AESDK:description>
                </AESDK:node>
            </AESDK:resourceDescriptions>
            <AESDK:adapterTester>
        ...
        <activedb xmlns="http://www.tibco.com/xmlns/adapter/ADB/2002">
            ...
            <agentOptions>
                ...
                <verbose>on</verbose>
                <useTraceFile/>
                <termSubject>%%Destinations/Topics/SDIDMHHDE_TERMINATION_TOPIC%%</termSubject>
        ...
        <operations xmlns="http://www.tibco.com/xmlns/adapter/ADB/2002">
            <publisher>
                <name>PMMSDIDMHHDE_Pub_Svc</name>
                <deployed>true</deployed>
                <isAdorapps>false</isAdorapps>
                <transportType>jms</transportType>
                <destination>%%Destinations/Queues/PRODUCTDIMENSION_PUB_ADB_QUEUE%%</destination>
                <endpointReference isRef="true">#jmsProducer.PMMSDIDMHHDE_Pub_Svc</endpointReference>
                <classReference isRef="true">/AESchemas/ae/ADB/PMMSDIDMHHDE_ADB_Adapter_Cfg.aeschema#class.PMM.HEB_P_SDIDMHHDE</classReference>
                <schemas>
                    <table>
                        <name>P_SDIDMHHDE</name>
                        ...
                        <userKeys>PRD_PDH_KEY</userKeys>
                        <userKeys>PRD_PDD_KEY</userKeys>
                    </table>
                </schemas>
                ...
                <sourceTable>PMM.SDIDMHHDE</sourceTable>
                <publishingTable>PMM.HEB_P_SDIDMHHDE</publishingTable>
                ...
                <columnsToPublish>PRD_PDH_KEY</columnsToPublish>
                <columnsToPublish>PRD_PDD_KEY</columnsToPublish>
                <columnsToPublish>TRAN_TYPE</columnsToPublish>
                <columnsToPublish>PRD_PDH_NAME</columnsToPublish>
                <columnsToPublish>PRD_PDD_SEQ</columnsToPublish>
                <columnsToPublish>PRD_PDH_ORDER</columnsToPublish>
                <columnsToPublish>PRD_PDD_CODE</columnsToPublish>
                <columnsToPublish>PRD_PDD_NAME</columnsToPublish>
                ...
                <userDefinedKey>PRD_PDH_KEY</userDefinedKey>
                <userDefinedKey>PRD_PDD_KEY</userDefinedKey>
    ...
    <jmsProducer xmlns="http://www.tibco.com/xmlns/aemeta/services/2002" name="PMMSDIDMHHDE_Pub_Svc" objectType="endpoint.JMSPublisher">
        ...
        <class isRef="true">/AESchemas/ae/ADB/PMMSDIDMHHDE_ADB_Adapter_Cfg.aeschema#class.PMM.HEB_P_SDIDMHHDE</class>
    </jmsProducer>
