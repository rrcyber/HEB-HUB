...
<Repository:repository xmlns:Repository="http://www.tibco.com/xmlns/repo/types/2002" xmlns:AESDK="http://www.tibco.com/xmlns/aemeta/adapter/2002" xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <ADB:adapter xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" name="PMMHEB_SDIAPDEE_ADB_Adapter_Cfg">
        <AESDK:instanceId>PMMHEB_SDIAPDEE_ADB_Adapter_Cfg</AESDK:instanceId>
        <AESDK:startup>
            ...
            <AESDK:startComponent>
                <AESDK:name>PMMHEB_SDIAPDEE_Pub_svc</AESDK:name>
                <AESDK:state>active</AESDK:state>
            </AESDK:startComponent>
        </AESDK:startup>
        <AESDK:deployment>
            ...
            <AESDK:producers>
                <AESDK:jmsPublisher isRef="true">#jmsProducer.PMMHEB_SDIAPDEE_Pub_svc</AESDK:jmsPublisher>
            </AESDK:producers>
        ...
        <AESDK:metadata>
            ...
            <AESDK:loadUrl isRef="false">/AESchemas/ae/ADB/PMMHEB_SDIAPDEE_ADB_Adapter_Cfg.aeschema</AESDK:loadUrl>
        </AESDK:metadata>
        ...
        <AESDK:designer>
            ...
            <AESDK:lockedProperties>
                ...
                <AESDK:locked>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMHEB_SDIAPDEE_Pub_svc</AESDK:resource>
            ...
            <AESDK:fixedChildren>
                ...
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue</AESDK:resource>
                    <AESDK:children>PMMHEB_SDIAPDEE_Pub_svc</AESDK:children>
                </AESDK:fixed>
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMHEB_SDIAPDEE_Pub_svc</AESDK:resource>
                    <AESDK:children>PMM.HEB_P_HEB_SDIAPDEE</AESDK:children>
                </AESDK:fixed>
            </AESDK:fixedChildren>
            <AESDK:resourceDescriptions>
                <AESDK:node>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMHEB_SDIAPDEE_Pub_svc</AESDK:resource>
                    <AESDK:description>Created for service PMMHEB_SDIAPDEE_Pub_svc.</AESDK:description>
                </AESDK:node>
            </AESDK:resourceDescriptions>
            <AESDK:adapterTester>
        ...
        <activedb xmlns="http://www.tibco.com/xmlns/adapter/ADB/2002">
            ...
            <agentOptions>
                ...
                <verbose>on</verbose>
                <useTraceFile/>
                <termSubject>%%Destinations/Topics/HEB_SDIAPDEE_TERMINATION_TOPIC%%</termSubject>
        ...
        <operations xmlns="http://www.tibco.com/xmlns/adapter/ADB/2002">
            <publisher>
                <name>PMMHEB_SDIAPDEE_Pub_svc</name>
                <deployed>true</deployed>
                <isAdorapps>false</isAdorapps>
                <transportType>jms</transportType>
                <destination>%%Destinations/Queues/PRODUCTASSORTMENTPLAN_PUB_ADB_QUEUE%%</destination>
                <endpointReference isRef="true">#jmsProducer.PMMHEB_SDIAPDEE_Pub_svc</endpointReference>
                <classReference isRef="true">/AESchemas/ae/ADB/PMMHEB_SDIAPDEE_ADB_Adapter_Cfg.aeschema#class.PMM.HEB_P_HEB_SDIAPDEE</classReference>
                <schemas>
                    <table>
                        <name>P_HEB_SDIAPDEE</name>
                ...
                <sourceTable>PMM.HEB_SDIAPDEE</sourceTable>
                <publishingTable>PMM.HEB_P_HEB_SDIAPDEE</publishingTable>
                ...
                <columnsToPublish>PRD_APH_KEY</columnsToPublish>
                <columnsToPublish>PRD_APH_CODE</columnsToPublish>
                <columnsToPublish>PRD_APH_NAME</columnsToPublish>
                <columnsToPublish>PRD_APH_PLAN_TYPE</columnsToPublish>
                ...
                <columnsToPublish>PRD_APH_QTY_RATIO</columnsToPublish>
    ...
    <jmsProducer xmlns="http://www.tibco.com/xmlns/aemeta/services/2002" name="PMMHEB_SDIAPDEE_Pub_svc" objectType="endpoint.JMSPublisher">
        ...
        <class isRef="true">/AESchemas/ae/ADB/PMMHEB_SDIAPDEE_ADB_Adapter_Cfg.aeschema#class.PMM.HEB_P_HEB_SDIAPDEE</class>
    </jmsProducer>
