...
<Repository:repository xmlns:Repository="http://www.tibco.com/xmlns/repo/types/2002" xmlns:AESDK="http://www.tibco.com/xmlns/aemeta/adapter/2002" xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <ADB:adapter xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" name="PMMSDIINVCUT_ADB_Adapter_Cfg">
        <AESDK:instanceId>PMMSDIINVCUT_ADB_Adapter_Cfg</AESDK:instanceId>
        <AESDK:startup>
            ...
            <AESDK:startComponent>
                <AESDK:name>PMMSDIINVCUT_Pub_Svc</AESDK:name>
                <AESDK:state>active</AESDK:state>
            </AESDK:startComponent>
        </AESDK:startup>
        <AESDK:deployment>
            ...
            <AESDK:producers>
                <AESDK:jmsPublisher isRef="true">#jmsProducer.PMMSDIINVCUT_Pub_Svc</AESDK:jmsPublisher>
            </AESDK:producers>
        ...
        <AESDK:metadata>
            ...
            <AESDK:loadUrl isRef="false">/AESchemas/ae/ADB/PMMSDIINVCUT_ADB_Adapter_Cfg.aeschema</AESDK:loadUrl>
        </AESDK:metadata>
        ...
        <AESDK:designer>
            ...
            <AESDK:lockedProperties>
                ...
                <AESDK:locked>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMSDIINVCUT_Pub_Svc</AESDK:resource>
            ...
            <AESDK:fixedChildren>
                ...
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue</AESDK:resource>
                    <AESDK:children>PMMSDIINVCUT_Pub_Svc</AESDK:children>
                </AESDK:fixed>
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMSDIINVCUT_Pub_Svc</AESDK:resource>
                    <AESDK:children>PMM.HEB_P_SDIINVCUT</AESDK:children>
                </AESDK:fixed>
            </AESDK:fixedChildren>
            <AESDK:resourceDescriptions>
                <AESDK:node>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMSDIINVCUT_Pub_Svc</AESDK:resource>
                    <AESDK:description>Created for service PMMSDIINVCUT_Pub_Svc.</AESDK:description>
                </AESDK:node>
            </AESDK:resourceDescriptions>
            <AESDK:adapterTester>
        ...
        <activedb xmlns="http://www.tibco.com/xmlns/adapter/ADB/2002">
            ...
            <agentOptions>
                ...
                <verbose>on</verbose>
                <useTraceFile/>
                <termSubject>%%Destinations/Topics/SDIINVCUT_TERMINATION_TOPIC%%</termSubject>
        ...
        <operations xmlns="http://www.tibco.com/xmlns/adapter/ADB/2002">
            <publisher>
                <name>PMMSDIINVCUT_Pub_Svc</name>
                <deployed>true</deployed>
                <isAdorapps>false</isAdorapps>
                <transportType>jms</transportType>
                <destination>%%Destinations/Queues/CUTTESTHEADER_PUB_ADB_QUEUE%%</destination>
                <endpointReference isRef="true">#jmsProducer.PMMSDIINVCUT_Pub_Svc</endpointReference>
                <classReference isRef="true">/AESchemas/ae/ADB/PMMSDIINVCUT_ADB_Adapter_Cfg.aeschema#class.PMM.HEB_P_SDIINVCUT</classReference>
                <schemas>
                    <table>
                        <name>P_SDIINVCUT</name>
                        ...
                        <userKeys>AUDIT_NUMBER</userKeys>
                        <userKeys>TRAN_TYPE</userKeys>
                        <userKeys>ISS_TECH_KEY</userKeys>
                        <userKeys>PRD_LVL_CHILD</userKeys>
                        <userKeys>CUT_TEST_DATE</userKeys>
                        <userKeys>CUT_TEST_NUMBER</userKeys>
                        <userKeys>ORG_LVL_CHILD_POS</userKeys>
                    </table>
                </schemas>
                ...
                <sourceTable>PMM.SDIINVCUT</sourceTable>
                <publishingTable>PMM.HEB_P_SDIINVCUT</publishingTable>
                ...
                <columnsToPublish>PRD_LVL_CHILD</columnsToPublish>
                <columnsToPublish>CUT_TEST_DATE</columnsToPublish>
                <columnsToPublish>CUT_TEST_NUMBER</columnsToPublish>
                <columnsToPublish>ORG_LVL_CHILD_POS</columnsToPublish>
                <columnsToPublish>ORG_LVL_NUMBER_POS</columnsToPublish>
                <columnsToPublish>ORG_LVL_CHILD</columnsToPublish>
                <columnsToPublish>ORG_LVL_NUMBER</columnsToPublish>
                <columnsToPublish>PRD_LVL_NUMBER</columnsToPublish>
                <columnsToPublish>VPC_TECH_KEY</columnsToPublish>
                <columnsToPublish>VENDOR_NUMBER</columnsToPublish>
                <columnsToPublish>GRADE_CODE</columnsToPublish>
                <columnsToPublish>CAP_CHAIN_ID</columnsToPublish>
                <columnsToPublish>PRC_TYPE</columnsToPublish>
                <columnsToPublish>PRC_PROMO_TYPE</columnsToPublish>
                <columnsToPublish>CURR_CODE</columnsToPublish>
                <columnsToPublish>CUT_WEIGHT_UOM</columnsToPublish>
                <columnsToPublish>CUT_ORIG_WEIGHT</columnsToPublish>
                <columnsToPublish>CUT_PCKG_WEIGHT</columnsToPublish>
                <columnsToPublish>WEIGHT_NO_PCKG</columnsToPublish>
                <columnsToPublish>CUT_SHRINK_RATE</columnsToPublish>
                <columnsToPublish>CUT_NET_WEIGHT</columnsToPublish>
                <columnsToPublish>CUT_SYS_COST</columnsToPublish>
                <columnsToPublish>CUT_OVER_COST</columnsToPublish>
                <columnsToPublish>CUT_PROD_CNT</columnsToPublish>
                <columnsToPublish>CUT_MKT_LOSS_PCT</columnsToPublish>
                <columnsToPublish>TOT_ACT_AVG_WGT</columnsToPublish>
                <columnsToPublish>TOT_AVG_CUT_WGT</columnsToPublish>
                <columnsToPublish>TOT_WSTE_TOT_WGT</columnsToPublish>
                <columnsToPublish>TOT_WSTE_TOT_AVG</columnsToPublish>
                <columnsToPublish>TOT_SHRNK_TOT_WGT</columnsToPublish>
                <columnsToPublish>TOT_SHRNK_TOT_AVG</columnsToPublish>
                <columnsToPublish>TEST_TOT_ACT_WGT</columnsToPublish>
                <columnsToPublish>TEST_TOT_AVG_CUT</columnsToPublish>
                <columnsToPublish>PROJ_SLS_VAL_REG</columnsToPublish>
                <columnsToPublish>PROJ_SLS_VAL_PROMO</columnsToPublish>
                <columnsToPublish>MKT_LOSS_VAL_REG</columnsToPublish>
                <columnsToPublish>MKT_LOSS_VAL_PROMO</columnsToPublish>
                <columnsToPublish>SUB_SLS_VAL_REG</columnsToPublish>
                <columnsToPublish>SUB_SLS_VAL_PROMO</columnsToPublish>
                <columnsToPublish>DIRECT_MRGN_REG</columnsToPublish>
                <columnsToPublish>DIRECT_MRGN_PROMO</columnsToPublish>
                <columnsToPublish>PERCENT_MRGN_REG</columnsToPublish>
                <columnsToPublish>PERCENT_MRGN_PROMO</columnsToPublish>
                <columnsToPublish>COST_RETR_METH</columnsToPublish>
                <userDefinedKey>AUDIT_NUMBER</userDefinedKey>
                <userDefinedKey>TRAN_TYPE</userDefinedKey>
                <userDefinedKey>ISS_TECH_KEY</userDefinedKey>
                <userDefinedKey>PRD_LVL_CHILD</userDefinedKey>
                <userDefinedKey>CUT_TEST_DATE</userDefinedKey>
                <userDefinedKey>CUT_TEST_NUMBER</userDefinedKey>
                <userDefinedKey>ORG_LVL_CHILD_POS</userDefinedKey>
    ...
    <jmsProducer xmlns="http://www.tibco.com/xmlns/aemeta/services/2002" name="PMMSDIINVCUT_Pub_Svc" objectType="endpoint.JMSPublisher">
        ...
        <class isRef="true">/AESchemas/ae/ADB/PMMSDIINVCUT_ADB_Adapter_Cfg.aeschema#class.PMM.HEB_P_SDIINVCUT</class>
    </jmsProducer>
