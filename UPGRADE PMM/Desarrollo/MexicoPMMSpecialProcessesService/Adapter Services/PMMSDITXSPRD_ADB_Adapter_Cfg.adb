...
<Repository:repository xmlns:Repository="http://www.tibco.com/xmlns/repo/types/2002" xmlns:AESDK="http://www.tibco.com/xmlns/aemeta/adapter/2002" xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <ADB:adapter xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" name="PMMSDITXSPRD_ADB_Adapter_Cfg">
        <AESDK:instanceId>PMMSDITXSPRD_ADB_Adapter_Cfg</AESDK:instanceId>
        <AESDK:startup>
            ...
            <AESDK:startComponent>
                <AESDK:name>PMMSDITXSPRD_Pub_Svc</AESDK:name>
                <AESDK:state>active</AESDK:state>
            </AESDK:startComponent>
        </AESDK:startup>
        <AESDK:deployment>
            ...
            <AESDK:producers>
                <AESDK:jmsPublisher isRef="true">#jmsProducer.PMMSDITXSPRD_Pub_Svc</AESDK:jmsPublisher>
            </AESDK:producers>
        ...
        <AESDK:metadata>
            <AESDK:loadUrl isRef="false">/AESchemas/ae/ADB/PMMSDITXSPRD_ADB_Adapter_Cfg.aeschema</AESDK:loadUrl>
        ...
        <AESDK:designer>
            ...
            <AESDK:lockedProperties>
                ...
                <AESDK:locked>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMSDITXSPRD_Pub_Svc</AESDK:resource>
            ...
            <AESDK:fixedChildren>
                ...
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue</AESDK:resource>
                    <AESDK:children>PMMSDITXSPRD_Pub_Svc</AESDK:children>
                </AESDK:fixed>
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMSDITXSPRD_Pub_Svc</AESDK:resource>
                    <AESDK:children>PMM.HEB_P_SDITXSPRD</AESDK:children>
                </AESDK:fixed>
            </AESDK:fixedChildren>
            <AESDK:resourceDescriptions>
                <AESDK:node>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMSDITXSPRD_Pub_Svc</AESDK:resource>
                    <AESDK:description>Created for service PMMSDITXSPRD_Pub_Svc.</AESDK:description>
                </AESDK:node>
            </AESDK:resourceDescriptions>
            <AESDK:adapterTester>
        ...
        <activedb xmlns="http://www.tibco.com/xmlns/adapter/ADB/2002">
            ...
            <agentOptions>
                ...
                <verbose>on</verbose>
                <useTraceFile/>
                <termSubject>%%Destinations/Topics/SDITXSPRD_TERMINATION_TOPIC%%</termSubject>
        ...
        <operations xmlns="http://www.tibco.com/xmlns/adapter/ADB/2002">
            <publisher>
                <name>PMMSDITXSPRD_Pub_Svc</name>
                <deployed>true</deployed>
                <isAdorapps>false</isAdorapps>
                <transportType>jms</transportType>
                <destination>%%Destinations/Queues/TAXESPRODUCT_PUB_ADB_QUEUE%%</destination>
                <endpointReference isRef="true">#jmsProducer.PMMSDITXSPRD_Pub_Svc</endpointReference>
                <classReference isRef="true">/AESchemas/ae/ADB/PMMSDITXSPRD_ADB_Adapter_Cfg.aeschema#class.PMM.HEB_P_SDITXSPRD</classReference>
                <schemas>
                    <table>
                        <name>P_SDITXSPRD</name>
                        ...
                        <userKeys>TXS_RATE_TYPE</userKeys>
                    </table>
                </schemas>
                ...
                <sourceTable>PMM.SDITXSPRD</sourceTable>
                <publishingTable>PMM.HEB_P_SDITXSPRD</publishingTable>
                ...
                <columnsToPublish>PRD_LVL_ID</columnsToPublish>
                <columnsToPublish>TXS_CODE</columnsToPublish>
                <columnsToPublish>TXS_EXEMPTION</columnsToPublish>
                ...
                <userDefinedKey>TXS_RATE_TYPE</userDefinedKey>
    ...
    <jmsSession xmlns="http://www.tibco.com/xmlns/aemeta/services/2002" name="JMSQueue" objectType="session.JMS">
        <connUsername>%%Connections/JMS/EMS/MIG_EMS_USERNAME%%</connUsername>
        <connPassword>%%Connections/JMS/EMS/MIG_EMS_PASSWORD%%</connPassword>
    ...
    <jmsProducer xmlns="http://www.tibco.com/xmlns/aemeta/services/2002" name="PMMSDITXSPRD_Pub_Svc" objectType="endpoint.JMSPublisher">
        ...
        <class isRef="true">/AESchemas/ae/ADB/PMMSDITXSPRD_ADB_Adapter_Cfg.aeschema#class.PMM.HEB_P_SDITXSPRD</class>
    </jmsProducer>
