...
<Repository:repository xmlns:Repository="http://www.tibco.com/xmlns/repo/types/2002" xmlns:AESDK="http://www.tibco.com/xmlns/aemeta/adapter/2002" xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <ADB:adapter xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" name="PMMHEB_SDIFXSEE_ADB_Adapter_Cfg">
        <AESDK:instanceId>PMMHEB_SDIFXSEE_ADB_Adapter_Cfg</AESDK:instanceId>
        <AESDK:startup>
            ...
            <AESDK:startComponent>
                <AESDK:name>PMMHEB_SDIFXSEE_Pub_Svc</AESDK:name>
                <AESDK:state>active</AESDK:state>
            </AESDK:startComponent>
        </AESDK:startup>
        <AESDK:deployment>
            ...
            <AESDK:producers>
                <AESDK:jmsPublisher isRef="true">#jmsProducer.PMMHEB_SDIFXSEE_Pub_Svc</AESDK:jmsPublisher>
            </AESDK:producers>
        ...
        <AESDK:metadata>
            ...
            <AESDK:loadUrl isRef="false">/AESchemas/ae/ADB/PMMHEB_SDIFXSEE_ADB_Adapter_Cfg.aeschema</AESDK:loadUrl>
        </AESDK:metadata>
        ...
        <AESDK:designer>
            ...
            <AESDK:lockedProperties>
                ...
                <AESDK:locked>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMHEB_SDIFXSEE_Pub_Svc</AESDK:resource>
            ...
            <AESDK:fixedChildren>
                ...
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue</AESDK:resource>
                    <AESDK:children>PMMHEB_SDIFXSEE_Pub_Svc</AESDK:children>
                </AESDK:fixed>
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMHEB_SDIFXSEE_Pub_Svc</AESDK:resource>
                    <AESDK:children>PMM.HEB_P_HEB_SDIFXSEE</AESDK:children>
                </AESDK:fixed>
            </AESDK:fixedChildren>
            <AESDK:resourceDescriptions>
                <AESDK:node>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMHEB_SDIFXSEE_Pub_Svc</AESDK:resource>
                    <AESDK:description>Created for service PMMHEB_SDIFXSEE_Pub_Svc.</AESDK:description>
                </AESDK:node>
            </AESDK:resourceDescriptions>
            <AESDK:adapterTester>
        ...
        <activedb xmlns="http://www.tibco.com/xmlns/adapter/ADB/2002">
            ...
            <agentOptions>
                ...
                <verbose>on</verbose>
                <useTraceFile/>
                <termSubject>%%Destinations/Topics/HEB_SDIFXSEE_TERMINATION_TOPIC%%</termSubject>
        ...
        <operations xmlns="http://www.tibco.com/xmlns/adapter/ADB/2002">
            <publisher>
                <name>PMMHEB_SDIFXSEE_Pub_Svc</name>
                <deployed>true</deployed>
                <isAdorapps>false</isAdorapps>
                <transportType>jms</transportType>
                <destination>%%Destinations/Queues/ASSORTMENTFORMATSTORE_PUB_ADB_QUEUE%%</destination>
                <endpointReference isRef="true">#jmsProducer.PMMHEB_SDIFXSEE_Pub_Svc</endpointReference>
                <classReference isRef="true">/AESchemas/ae/ADB/PMMHEB_SDIFXSEE_ADB_Adapter_Cfg.aeschema#class.PMM.HEB_P_HEB_SDIFXSEE</classReference>
                <schemas>
                    <table>
                        <name>P_HEB_SDIFXSEE</name>
                ...
                <sourceTable>PMM.HEB_SDIFXSEE</sourceTable>
                <publishingTable>PMM.HEB_P_HEB_SDIFXSEE</publishingTable>
                ...
                <columnsToPublish>SEQ_NUMBER</columnsToPublish>
    ...
    <jmsProducer xmlns="http://www.tibco.com/xmlns/aemeta/services/2002" name="PMMHEB_SDIFXSEE_Pub_Svc" objectType="endpoint.JMSPublisher">
        ...
        <class isRef="true">/AESchemas/ae/ADB/PMMHEB_SDIFXSEE_ADB_Adapter_Cfg.aeschema#class.PMM.HEB_P_HEB_SDIFXSEE</class>
    </jmsProducer>
