...
<Repository:repository xmlns:Repository="http://www.tibco.com/xmlns/repo/types/2002" xmlns:AESDK="http://www.tibco.com/xmlns/aemeta/adapter/2002" xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <ADB:adapter xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" name="PMMSDITXSCOD_ADB_Adapter_Cfg">
        <AESDK:instanceId>PMMSDITXSCOD_ADB_Adapter_Cfg</AESDK:instanceId>
        <AESDK:startup>
            ...
            <AESDK:startComponent>
                <AESDK:name>PMMSDITXSCOD_Pub_Svc</AESDK:name>
                <AESDK:state>active</AESDK:state>
            </AESDK:startComponent>
        </AESDK:startup>
        <AESDK:deployment>
            ...
            <AESDK:producers>
                <AESDK:jmsPublisher isRef="true">#jmsProducer.PMMSDITXSCOD_Pub_Svc</AESDK:jmsPublisher>
            </AESDK:producers>
        ...
        <AESDK:metadata>
            ...
            <AESDK:loadUrl isRef="false">/AESchemas/ae/ADB/PMMSDITXSCOD_ADB_Adapter_Cfg.aeschema</AESDK:loadUrl>
        </AESDK:metadata>
        ...
        <AESDK:designer>
            ...
            <AESDK:lockedProperties>
                ...
                <AESDK:locked>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMSDITXSCOD_Pub_Svc</AESDK:resource>
            ...
            <AESDK:fixedChildren>
                ...
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue</AESDK:resource>
                    <AESDK:children>PMMSDITXSCOD_Pub_Svc</AESDK:children>
                </AESDK:fixed>
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMSDITXSCOD_Pub_Svc</AESDK:resource>
                    <AESDK:children>PMM.HEB_P_SDITXSCOD</AESDK:children>
                </AESDK:fixed>
            </AESDK:fixedChildren>
            <AESDK:resourceDescriptions>
                <AESDK:node>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMSDITXSCOD_Pub_Svc</AESDK:resource>
                    <AESDK:description>Created for service PMMSDITXSCOD_Pub_Svc.</AESDK:description>
                </AESDK:node>
            </AESDK:resourceDescriptions>
            <AESDK:adapterTester>
                <AESDK:args>--run --propFile</AESDK:args>
                <AESDK:exe>C:\tibco6\adapter\adadb\7.1\bin\adbagent.exe</AESDK:exe>
                <AESDK:workingDir>C:\TEMP</AESDK:workingDir>
            </AESDK:adapterTester>
        </AESDK:designer>
        ...
        <activedb xmlns="http://www.tibco.com/xmlns/adapter/ADB/2002">
            ...
            <agentOptions>
                ...
                <verbose>on</verbose>
                <useTraceFile/>
                <termSubject>%%Destinations/Topics/SDITXSCOD_TERMINATION_TOPIC%%</termSubject>
        ...
        <operations xmlns="http://www.tibco.com/xmlns/adapter/ADB/2002">
            <publisher>
                <name>PMMSDITXSCOD_Pub_Svc</name>
                <deployed>true</deployed>
                <isAdorapps>false</isAdorapps>
                <transportType>jms</transportType>
                <destination>%%Destinations/Queues/TAXESCODE_PUB_ADB_QUEUE%%</destination>
                <endpointReference isRef="true">#jmsProducer.PMMSDITXSCOD_Pub_Svc</endpointReference>
                <classReference isRef="true">/AESchemas/ae/ADB/PMMSDITXSCOD_ADB_Adapter_Cfg.aeschema#class.PMM.HEB_P_SDITXSCOD</classReference>
                <schemas>
                    <table>
                        <name>P_SDITXSCOD</name>
                        ...
                        <userKeys>ORG_LVL_CHILD</userKeys>
                        <userKeys>ISS_TECH_KEY</userKeys>
                        <userKeys>TRAN_TYPE</userKeys>
                        <userKeys>AUDIT_NUMBER</userKeys>
                        <userKeys>TXS_CODE_TECH_KEY</userKeys>
                        <userKeys>TXS_RATE_TECH_KEY</userKeys>
                    </table>
                </schemas>
                ...
                <sourceTable>PMM.SDITXSCOD</sourceTable>
                <publishingTable>PMM.HEB_P_SDITXSCOD</publishingTable>
                ...
                <columnsToPublish>TXS_CODE_TECH_KEY</columnsToPublish>
                <columnsToPublish>TXS_RATE_TECH_KEY</columnsToPublish>
                <columnsToPublish>ORG_LVL_NUMBER</columnsToPublish>
                <columnsToPublish>TXS_AUTH_CODE</columnsToPublish>
                <columnsToPublish>TXS_CODE</columnsToPublish>
                <columnsToPublish>TXS_CODE_DESC</columnsToPublish>
                <columnsToPublish>TXS_CALC_TYPE</columnsToPublish>
                <columnsToPublish>TXS_APP_TYPE</columnsToPublish>
                <columnsToPublish>TXS_INCL_RETAIL</columnsToPublish>
                <columnsToPublish>TXS_POS_OVER</columnsToPublish>
                <columnsToPublish>TXS_POS_EXEMPT</columnsToPublish>
                <columnsToPublish>TXS_EFF_FROM</columnsToPublish>
                <columnsToPublish>TXS_EFF_TO</columnsToPublish>
                <columnsToPublish>TXS_RATE</columnsToPublish>
                <columnsToPublish>TXS_AMT</columnsToPublish>
                <columnsToPublish>TXS_FROM_AMT</columnsToPublish>
                <columnsToPublish>TXS_TO_AMT</columnsToPublish>
                <columnsToPublish>TXS_FROM_QTY</columnsToPublish>
                <columnsToPublish>TXS_TO_QTY</columnsToPublish>
                <columnsToPublish>TXS_TBL_ID</columnsToPublish>
                <columnsToPublish>TXS_SEQ_NUM</columnsToPublish>
                <columnsToPublish>DATE_CREATED</columnsToPublish>
                <columnsToPublish>CURR_CODE</columnsToPublish>
                <columnsToPublish>TXS_RATE_TYPE</columnsToPublish>
                <userDefinedKey>ORG_LVL_CHILD</userDefinedKey>
                ...
                <userDefinedKey>TXS_CODE_TECH_KEY</userDefinedKey>
                <userDefinedKey>TXS_RATE_TECH_KEY</userDefinedKey>
    ...
    <jmsProducer xmlns="http://www.tibco.com/xmlns/aemeta/services/2002" name="PMMSDITXSCOD_Pub_Svc" objectType="endpoint.JMSPublisher">
        ...
        <class isRef="true">/AESchemas/ae/ADB/PMMSDITXSCOD_ADB_Adapter_Cfg.aeschema#class.PMM.HEB_P_SDITXSCOD</class>
    </jmsProducer>
