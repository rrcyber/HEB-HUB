...
<Repository:repository xmlns:Repository="http://www.tibco.com/xmlns/repo/types/2002" xmlns:AESDK="http://www.tibco.com/xmlns/aemeta/adapter/2002" xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <ADB:adapter xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" name="PMMSDIINVCTP_ADB_Adapter_Cfg">
        <AESDK:instanceId>PMMSDIINVCTP_ADB_Adapter_Cfg</AESDK:instanceId>
        <AESDK:startup>
            ...
            <AESDK:startComponent>
                <AESDK:name>PMMSDIINVCTP_Pub_Svc</AESDK:name>
                <AESDK:state>active</AESDK:state>
            </AESDK:startComponent>
        </AESDK:startup>
        <AESDK:deployment>
            ...
            <AESDK:producers>
                <AESDK:jmsPublisher isRef="true">#jmsProducer.PMMSDIINVCTP_Pub_Svc</AESDK:jmsPublisher>
            </AESDK:producers>
        ...
        <AESDK:metadata>
            <AESDK:loadUrl isRef="false">/AESchemas/ae/ADB/PMMSDIINVCTP_ADB_Adapter_Cfg.aeschema</AESDK:loadUrl>
        ...
        <AESDK:designer>
            ...
            <AESDK:lockedProperties>
                ...
                <AESDK:locked>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMSDIINVCTP_Pub_Svc</AESDK:resource>
            ...
            <AESDK:fixedChildren>
                ...
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue</AESDK:resource>
                    <AESDK:children>PMMSDIINVCTP_Pub_Svc</AESDK:children>
                </AESDK:fixed>
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMSDIINVCTP_Pub_Svc</AESDK:resource>
                    <AESDK:children>PMM.HEB_P_SDIINVCTP</AESDK:children>
                </AESDK:fixed>
            </AESDK:fixedChildren>
            <AESDK:resourceDescriptions>
                <AESDK:node>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMSDIINVCTP_Pub_Svc</AESDK:resource>
                    <AESDK:description>Created for service PMMSDIINVCTP_Pub_Svc.</AESDK:description>
                </AESDK:node>
            </AESDK:resourceDescriptions>
            <AESDK:adapterTester>
        ...
        <activedb xmlns="http://www.tibco.com/xmlns/adapter/ADB/2002">
            ...
            <agentOptions>
                ...
                <verbose>on</verbose>
                <useTraceFile/>
                <termSubject>%%Destinations/Topics/SDIINVCTP_TERMINATION_TOPIC%%</termSubject>
        ...
        <operations xmlns="http://www.tibco.com/xmlns/adapter/ADB/2002">
            <publisher>
                <name>PMMSDIINVCTP_Pub_Svc</name>
                <deployed>true</deployed>
                <isAdorapps>false</isAdorapps>
                <transportType>jms</transportType>
                <destination>%%Destinations/Queues/CUTTESTDETAIL_PUB_ADB_QUEUE%%</destination>
                <endpointReference isRef="true">#jmsProducer.PMMSDIINVCTP_Pub_Svc</endpointReference>
                <classReference isRef="true">/AESchemas/ae/ADB/PMMSDIINVCTP_ADB_Adapter_Cfg.aeschema#class.PMM.HEB_P_SDIINVCTP</classReference>
                <schemas>
                    <table>
                        <name>P_SDIINVCTP</name>
                        ...
                        <userKeys>PRD_LVL_CHILD_CUT</userKeys>
                ...
                <sourceTable>PMM.SDIINVCTP</sourceTable>
                <publishingTable>PMM.HEB_P_SDIINVCTP</publishingTable>
                ...
                <columnsToPublish>PRD_LVL_CHILD_CUT</columnsToPublish>
                ...
                <columnsToPublish>PRD_LVL_NUMBER_CUT</columnsToPublish>
                <columnsToPublish>COMP_TYPE</columnsToPublish>
                <columnsToPublish>AVG_CUT_WEIGHT</columnsToPublish>
                <columnsToPublish>PRICE_REG</columnsToPublish>
                <columnsToPublish>PRICE_PROMO</columnsToPublish>
                <columnsToPublish>PRICE_REG_OVR</columnsToPublish>
                <columnsToPublish>PRICE_PROMO_OVR</columnsToPublish>
                <columnsToPublish>CUT_SLS_VAL_REG</columnsToPublish>
                <columnsToPublish>CUT_SLS_VAL_PROMO</columnsToPublish>
                <columnsToPublish>YIELD_COST</columnsToPublish>
                <columnsToPublish>CUT_MARGIN</columnsToPublish>
                <columnsToPublish>ACT_AVG_WEIGHT</columnsToPublish>
                ...
                <userDefinedKey>PRD_LVL_CHILD_CUT</userDefinedKey>
    ...
    <jmsProducer xmlns="http://www.tibco.com/xmlns/aemeta/services/2002" name="PMMSDIINVCTP_Pub_Svc" objectType="endpoint.JMSPublisher">
        ...
        <class isRef="true">/AESchemas/ae/ADB/PMMSDIINVCTP_ADB_Adapter_Cfg.aeschema#class.PMM.HEB_P_SDIINVCTP</class>
    </jmsProducer>
