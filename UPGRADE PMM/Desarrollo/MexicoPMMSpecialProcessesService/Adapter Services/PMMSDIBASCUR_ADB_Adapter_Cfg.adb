...
<Repository:repository xmlns:Repository="http://www.tibco.com/xmlns/repo/types/2002" xmlns:AESDK="http://www.tibco.com/xmlns/aemeta/adapter/2002" xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <ADB:adapter xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" name="PMMSDIBASCUR_ADB_Adapter_Cfg">
        <AESDK:instanceId>PMMSDIBASCUR_ADB_Adapter_Cfg</AESDK:instanceId>
        <AESDK:startup>
            ...
            <AESDK:startComponent>
                <AESDK:name>PMMSDIBASCUR_Pub_Svc</AESDK:name>
                <AESDK:state>active</AESDK:state>
            </AESDK:startComponent>
        </AESDK:startup>
        <AESDK:deployment>
            ...
            <AESDK:producers>
                <AESDK:jmsPublisher isRef="true">#jmsProducer.PMMSDIBASCUR_Pub_Svc</AESDK:jmsPublisher>
            </AESDK:producers>
        ...
        <AESDK:metadata>
            <AESDK:loadUrl isRef="false">/AESchemas/ae/ADB/PMMSDIBASCUR_ADB_Adapter_Cfg.aeschema</AESDK:loadUrl>
        ...
        <AESDK:designer>
            ...
            <AESDK:lockedProperties>
                ...
                <AESDK:locked>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMSDIBASCUR_Pub_Svc</AESDK:resource>
            ...
            <AESDK:fixedChildren>
                ...
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue</AESDK:resource>
                    <AESDK:children>PMMSDIBASCUR_Pub_Svc</AESDK:children>
                </AESDK:fixed>
                <AESDK:fixed>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMSDIBASCUR_Pub_Svc</AESDK:resource>
                    <AESDK:children>PMM.HEB_P_SDIBASCUR</AESDK:children>
                </AESDK:fixed>
            </AESDK:fixedChildren>
            <AESDK:resourceDescriptions>
                <AESDK:node>
                    <AESDK:resource>/Advanced/Sessions/JMSQueue/PMMSDIBASCUR_Pub_Svc</AESDK:resource>
                    <AESDK:description>Created for service PMMSDIBASCUR_Pub_Svc.</AESDK:description>
                </AESDK:node>
            </AESDK:resourceDescriptions>
            <AESDK:adapterTester>
        ...
        <activedb xmlns="http://www.tibco.com/xmlns/adapter/ADB/2002">
            ...
            <agentOptions>
                ...
                <verbose>on</verbose>
                <useTraceFile/>
                <termSubject>%%Destinations/Topics/SDIBASCUR_TERMINATION_TOPIC%%</termSubject>
        ...
        <operations xmlns="http://www.tibco.com/xmlns/adapter/ADB/2002">
            <publisher>
                <name>PMMSDIBASCUR_Pub_Svc</name>
                <deployed>true</deployed>
                <isAdorapps>false</isAdorapps>
                <transportType>jms</transportType>
                <destination>%%Destinations/Queues/SDIBASCUR_PUB_ADB_QUEUE%%</destination>
                <endpointReference isRef="true">#jmsProducer.PMMSDIBASCUR_Pub_Svc</endpointReference>
                <classReference isRef="true">/AESchemas/ae/ADB/PMMSDIBASCUR_ADB_Adapter_Cfg.aeschema#class.PMM.HEB_P_SDIBASCUR</classReference>
                <schemas>
                    <table>
                        <name>P_SDIBASCUR</name>
                        ...
                        <userKeys>CURR_CODE</userKeys>
                        <userKeys>TO_CURR_CODE</userKeys>
                        <userKeys>ISS_TECH_KEY</userKeys>
                        <userKeys>TRAN_TYPE</userKeys>
                        <userKeys>AUDIT_NUMBER</userKeys>
                        <userKeys>RATE_YR</userKeys>
                        <userKeys>RATE_PR</userKeys>
                        <userKeys>RATE_WK</userKeys>
                        <userKeys>RATE_DY</userKeys>
                    </table>
                </schemas>
                ...
                <sourceTable>PMM.SDIBASCUR</sourceTable>
                <publishingTable>PMM.HEB_P_SDIBASCUR</publishingTable>
                ...
                <columnsToPublish>TO_CURR_CODE</columnsToPublish>
                ...
                <columnsToPublish>ISS_TYPE</columnsToPublish>
                <columnsToPublish>ORG_LVL_NUMBER</columnsToPublish>
                <columnsToPublish>RATE_YR</columnsToPublish>
                <columnsToPublish>RATE_PR</columnsToPublish>
                <columnsToPublish>RATE_WK</columnsToPublish>
                <columnsToPublish>RATE_DY</columnsToPublish>
                <columnsToPublish>RATE_DATE</columnsToPublish>
                <columnsToPublish>RATE_RATE</columnsToPublish>
                <columnsToPublish>DATE_CREATED</columnsToPublish>
                <columnsToPublish>RATE_RECIPRICAL</columnsToPublish>
                <columnsToPublish>MD_FLAG</columnsToPublish>
                <columnsToPublish>FRM_RND_MULT</columnsToPublish>
                <columnsToPublish>TO_RND_MULT</columnsToPublish>
                <columnsToPublish>RND_TYPE</columnsToPublish>
                <userDefinedKey>ORG_LVL_CHILD</userDefinedKey>
                <userDefinedKey>CURR_CODE</userDefinedKey>
                <userDefinedKey>TO_CURR_CODE</userDefinedKey>
                ...
                <userDefinedKey>RATE_YR</userDefinedKey>
                <userDefinedKey>RATE_PR</userDefinedKey>
                <userDefinedKey>RATE_WK</userDefinedKey>
                <userDefinedKey>RATE_DY</userDefinedKey>
    ...
    <jmsProducer xmlns="http://www.tibco.com/xmlns/aemeta/services/2002" name="PMMSDIBASCUR_Pub_Svc" objectType="endpoint.JMSPublisher">
        ...
        <class isRef="true">/AESchemas/ae/ADB/PMMSDIBASCUR_ADB_Adapter_Cfg.aeschema#class.PMM.HEB_P_SDIBASCUR</class>
    </jmsProducer>
